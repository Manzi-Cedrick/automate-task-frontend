...
const CreateUser = ({ showModal, onClose }: { showModal: Boolean, onClose: any }) => {
            ...
            <div className='bg-white text-black py-2 px-10 w-[36vw] rounded-sm'>
                ...
                <div className='modal-body text-slate-500'>
                    <div>
                        ...
                        <input className="shadow appearance-none bg-inputG border rounded w-full py-3 text-[10px] px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter user name" />
                    </div>
                    <div>
                        <label className="block text-gray-700 text-[12px] py-2">
                            Email
                        </label>
                        <input className="shadow appearance-none bg-inputG border rounded w-full py-3 text-[10px] px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Enter user email" />
                    </div>
                    <div>
                        <label className="block text-gray-700 text-[12px] py-2">
                            Password
                        </label>
                        <input className="shadow appearance-none bg-inputG border rounded w-full py-3 text-[10px] px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="Enter user password" />
                    </div>
                    <div>
                        <label className="block text-gray-700 text-[12px] py-2">
                            Role
